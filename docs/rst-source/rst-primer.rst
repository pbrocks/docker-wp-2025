...
Let's hope the text below **contains** links that look like "(quickref__)".  These
...
Note that `Document Title`__ and "Section Title" above both use equals
signs, but are distict and unrelated styles.  The text of
overline-and-underlined titles (but not underlined-only) may be inset
for aesthetics.

__ docker-compose.html#moki-nginx-yaml-directives
...
__ docker-compose.html#nginx-container
